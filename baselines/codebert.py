...
class CodeBertClassifier(nn.Module):
    def __init__(self, bert_model_name='microsoft/codebert-base', num_classes=2): # microsoft/codebert-base; microsoft/graphcodebert-base
        super(CodeBertClassifier, self).__init__()
        self.bert = RobertaModel.from_pretrained(args.model_dir).to(DEVICE)
        # self.tokenizer = RobertaTokenizer.from_pretrained(args.model_dir)
...
def process(args):
    ...
    run_name = f"algo:codebert_data:{args.dataset}"
    ...
    model_folder = os.path.join(args.output_path, f"CodeBERT_{args.dataset}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", type=str, default=f"{CODEBERT_PATH}",
    ...
    parser.add_argument("--output_path", type=str, default="codebert/models/finetune", help="Path to save the best model.")
...
# python codebert.py --dataset diversevul --num_epochs 100
# python codebert.py --dataset draper --num_epochs 100
# python codebert.py --dataset reveal --num_epochs 100
# python codebert.py --dataset vuldeepecker --num_epochs 100
# python codebert.py --dataset mvd --num_epochs 100